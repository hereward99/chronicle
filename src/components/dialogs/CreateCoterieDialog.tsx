            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <MentionInput
                    ...
                    placeholder="Describe the coterie..."
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    value={domainResonance}
                    onChange={(e) => setDomainResonance(e.target.value)}
                    placeholder="Choleric"
                  />
                </div>
                <DotRatedList
                  items={domainMerits}
                  onChange={setDomainMerits}
                  label="Domain Merits"
                  placeholder="e.g. Herd, Rack..."
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    value={havenLocation}
                    onChange={(e) => setHavenLocation(e.target.value)}
                    placeholder="Abandoned warehouse on 5th Street"
                  />
                </div>
                <DotRatedList
                  items={havenMeritsAndFlaws}
                  onChange={setHavenMeritsAndFlaws}
                  label="Haven Merits & Flaws"
                  placeholder="e.g. Postern, Cell..."
                />
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <Textarea
                    value={coterieAdvantagesAndFlaws}
                    onChange={(e) => setCoterieAdvantagesAndFlaws(e.target.value)}
                    placeholder="Advantages and flaws..."
                    className="min-h-16"
                  />
                </div>
                <div className="space-y-1">
                  ...
                  <Textarea
                    value={coterieBoonsAndDebts}
                    onChange={(e) => setCoterieBoonsAndDebts(e.target.value)}
                    placeholder="Boons owed and debts..."
                    className="min-h-16"
                  />
                </div>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                  ...
                  <Textarea
                    ...
                    onChange={(e) => setChronicleTenets(e.target.value)}
                    placeholder="Chronicle tenets..."
                    className="min-h-16"
                  />
                </div>
                <div className="space-y-1">
                  ...
                  <Textarea
                    value={coterieGoals}
                    onChange={(e) => setCoterieGoals(e.target.value)}
                    placeholder="What does the coterie want to achieve?"
                    className="min-h-16"
                  />
                </div>
              </div>
